...
srun --partition=researchshort --gres=gpu:1 python cifar10-coerced.py --dataset 'cifar10-8-wen2023adversarial' --model resnet18_cifar --training_step attacked_classification_step  --atk PGD --atk-eps 0.03137254901 --atk-alpha 0.00784313725 --atk-steps 10 --optimizer AdamW --scheduler CosineAnnealingLR  --scheduler-T_max 200 --epochs 201

...
srun --partition=researchlong --gres=gpu:1 python cifar10-coerced.py --dataset 'cifar10-16-huang2021unlearnable' --model resnet20_svhn --training_step classification_step --optimizer AdamW --scheduler CosineAnnealingLR  --scheduler-T_max 200 --epochs 201
